...
The SIR Model [1]_ assumes that infection spreads only through links between neighboring nodes in a graph
...
.. [1] Youssef M, Scoglio C. An individual-based approach to SIR epidemics in contact networks[J].
        *Journal of theoretical biology*, 2011, 283(1): 136-144.
